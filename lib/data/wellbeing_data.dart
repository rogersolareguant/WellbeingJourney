...
const List<WellbeingQuestion> wellbeingQuestions = [
  WellbeingQuestion(
    text: 'I feel like I can make a lot of inputs to deciding how my schoolwork gets done',
  ...
  WellbeingQuestion(
    text: 'I really like the people I study with',
  ...
  WellbeingQuestion(
    text: 'I do not feel very competent when I am studying',
  ...
  WellbeingQuestion(
    text: 'People I learn with tell me I am good at what I do',
  ...
  WellbeingQuestion(
    text: 'I feel pressured during my studies',
  ...
  WellbeingQuestion(
    text: 'I get along with other students',
    recommendation: 'Encourage open communication with classmates to enhance mutual understanding and a positive atmosphere – Building strong relationships with your peers helps create a supportive learning environment.',
    dimension: WellbeingDimension.relatedness,
  ),
  WellbeingQuestion(
    text: 'I pretty much keep to myself during class or study time',
    recommendation: 'Initiate conversations with new people – Don’t hesitate to take the first step and talk to new classmates.',
    dimension: WellbeingDimension.relatedness,
    isReversed: true,
  ),
  WellbeingQuestion(
    text: 'I am free to express my ideas and opinions in class',
    recommendation: 'Embrace your individuality – Don\'t be afraid to bring your unique perspective into discussions; your ideas matter and can add value to the conversation.',
    dimension: WellbeingDimension.autonomy,
  ),
  WellbeingQuestion(
    text: 'I consider the people I study with to be my friends',
  ...
  WellbeingQuestion(
    text: 'I have been able to learn interesting new skills through my studies',
  ...
  WellbeingQuestion(
    text: 'During my studies, I have to do exactly what I’m told',
  ...
  WellbeingQuestion(
    text: 'Most days I feel a sense of accomplishment from learning',
  ...
  WellbeingQuestion(
    text: 'My feelings are taken into consideration in class',
  ...
  WellbeingQuestion(
    text: 'I don’t get many chances to show how capable I am through my studies',
  ...
  WellbeingQuestion(
    text: 'People I study with care about me',
  ...
  WellbeingQuestion(
    text: 'There are not many people I feel close to at school',
  ...
  WellbeingQuestion(
    text: 'I feel like I can pretty much be myself in school',
  ...
  WellbeingQuestion(
    text: 'The people I study with do not seem to like me much',
  ...
  WellbeingQuestion(
    text: 'When I’m studying, I often do not feel very capable',
  ...
  WellbeingQuestion(
    text: 'There is not much opportunity for me to decide for myself how to go about my studies',
  ...
  WellbeingQuestion(
    text: 'People at school are pretty friendly towards me',
    recommendation: 'Engage in team-building activities and collaborative projects to create opportunities for working together with fellow students – Actively participating in group work or team-building activities gives you the chance to connect with others.',
    dimension: WellbeingDimension.relatedness,
  ),
];
